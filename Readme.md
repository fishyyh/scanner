...
docker exec -it arl bash
# docker内运行，通过源码安装ARL
curl https://github.com/fishyyh/scanner/master/misc/setup-arl.sh >install.sh
bash install.sh
exit
```
...
```
wget https://github.com/fishyyh/scanner/master/misc/setup-arl.sh
...
curl https://github.com/fishyyh/scanner/refs/heads/master/tools/smartdns.conf > /etc/smartdns/smartdns.conf
